                                ...
                                <td class=" py-4 flex whitespace-nowrap text-sm font-medium">
                                    ...
                                    <div>
                                        <a wire:click="$emit('deleteProyecto', {{ $item->id }} )"
                                            class=" ml-2 mt-2 rounded-md font-ail bg-red-500 font-normal text-white border-2 border-white transition-all duration-200 group-hover:w-full ease hover:border-red-500 hover:text-red-500 hover:bg-white py-2 px-2 inline-flex items-center">
