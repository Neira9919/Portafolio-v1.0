...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-kh_main text-base font-medium text-kh_main bg-gray-200 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition'
